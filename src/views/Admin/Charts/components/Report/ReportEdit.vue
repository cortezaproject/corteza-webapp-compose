  ...
  <div>
    ...
    <div class="mt-1">
      <div class="border px-3 py-2 mb-2">
        <h5 class="mb-3">
          {{ $t('reportConfigure.meta.label') }}
        </h5>
        <b-form-group :label="$t('reportConfigure.meta.moduleLabel')">
          <b-form-select
            v-model="moduleID"
            :options="modules"
            text-field="name"
          ...
          >
            <template slot="first">
              <option
                ...
                disabled
              >
                {{ $t('reportConfigure.meta.modulePlaceholder') }}
              </option>
            </template>
          </b-form-select>
        </b-form-group>
    ...
    >
      <div class="border px-3 py-2 mb-2">
        <h5 class="mb-3">
          {{ $t('reportConfigure.filter.label') }}
        </h5>
        <b-form-group>
          <b-form-select
          ...
          >
            <template slot="first">
              <option :value="null">
                {{ $t('reportConfigure.filter.noFilter') }}
              </option>
            </template>
          </b-form-select>

          <b-form-checkbox v-model="customFilter">
            {{ $t('reportConfigure.filter.customize') }}
          </b-form-checkbox>
    ...
    <div v-if="!!module">
      <div class="border px-3 py-2 mb-2">
        ...
        >
          <h5 class="mb-3">
            {{ $t('reportConfigure.dimension.label') }}
          </h5>
          ...
          <b-form-group
            ...
            :label-cols="2"
            breakpoint="md"
            :label="$t('reportConfigure.dimension.fieldLabel')"
          >
            <b-form-select
              v-model="d.field"
            ...
            >
              <template slot="first">
                <option
                  ...
                  :value="undefined"
                >
                  {{ $t('reportConfigure.dimension.fieldPlaceholder') }}
                </option>
              </template>
            </b-form-select>
          </b-form-group>
          ...
          <b-form-group
            ...
            :label-cols="2"
            breakpoint="md"
            :label="$t('reportConfigure.dimension.function.label')"
          >
            <b-form-select
              v-model="d.modifier"
            ...
            >
              <template slot="first">
                <option
                  ...
                  :value="undefined"
                >
                  {{ $t('reportConfigure.dimension.function.placeholder') }}
                </option>
              </template>
            </b-form-select>
          </b-form-group>
          ...
          >
            ...
            >
              {{ $t('reportConfigure.dimension.skipMissingValues') }}
            </b-form-checkbox>
          </b-form-group>
          ...
          <b-form-group
            ...
            :label-cols="2"
            breakpoint="md"
            :label="$t('reportConfigure.dimension.defaultValueLabel')"
            :description="$t('reportConfigure.dimension.defaultValueFootnote')"
          >
            <b-form-input
              v-model="d.default"
      ...
      >
        ...
        >
          ...
          <h5 class="mb-3 d-inline-block">
            {{ $t('reportConfigure.metric.label') }}
          </h5>
          <b-button
            v-if="metrics.length > 1"
          ...
          <b-form-group
            ...
            :label-cols="2"
            breakpoint="md"
            :label="$t('reportConfigure.metric.fieldLabel')"
          >
            <b-form-select
              v-model="m.field"
            ...
            >
              <template slot="first">
                <option
                  ...
                  :value="undefined"
                >
                  {{ $t('reportConfigure.metric.fieldPlaceholder') }}
                </option>
              </template>
            </b-form-select>
          </b-form-group>
          ...
          <b-form-group
            ...
            :label-cols="2"
            breakpoint="md"
            :label="$t('reportConfigure.metric.function.label')"
          >
            <b-form-select
              v-model="m.aggregate"
            ...
            >
              <template slot="first">
                <option
                  ...
                  :value="undefined"
                >
                  {{ $t('reportConfigure.metric.function.placeholder') }}
                </option>
              </template>
            </b-form-select>
          </b-form-group>
...
export default {
  ...
  data () {
    return {
      ...
      metricAggregates: aggregateFunctions.map(af => ({ ...af, text: this.$t(`reportConfigure.metric.function.${af.text}`) })),
      dimensionModifiers: compose.chartUtil.dimensionFunctions.map(df => ({ ...df, text: this.$t(`reportConfigure.dimension.function.${df.text}`) })),
      predefinedFilters: compose.chartUtil.predefinedFilters.map(pf => ({ ...pf, text: this.$t(`reportConfigure.filter.${pf.text}`) })),
    }
  },

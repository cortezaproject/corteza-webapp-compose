<template>
  <section class="container well" id="modules-contents-index">
    <router-link :to="{name: 'admin.modules'}" class="btn-url">Back to Module list</router-link>
    <h2>{{module.name}}</h2>
    ...
    <table class="table sticky-header">
      <thead>
        <tr>
          <th v-for="moduleField in module.fields" :key="moduleField.id">
            {{moduleField.label || moduleField.name}}
          </th>

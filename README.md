...
Refer to the [Integrator Guide/Low-Code configuration](https://docs.cortezaproject.org/corteza-docs/2021.3/integrator-guide/compose-configuration/index.html) for details on how to use the web application.
...
[![Latest Version Card](https://img.shields.io/github/v/tag/cortezaproject/corteza-webapp-compose?label=latest%20stable%20version)](https://img.shields.io/github/v/tag/cortezaproject/corteza-webapp-compose?label=latest%20stable%20version)

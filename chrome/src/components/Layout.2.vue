    ...
    <multipane
      ...
      <template
        ...
        <div
          ...
          class="pane onepane-wrapper"
          :data-nb-items="paneset.length"
          :data-structure="panes.disposition.type + '-' + panesetindex"
          :style="{ width: panes.disposition.type==='colfirst'?''+(100/panes.disposition.itempos.length)+'%':'100%', height: panes.disposition.type==='colfirst'?'100%':''+(100/panes.disposition.itempos.length)+'%', flexGrow:1 }"
          :key="panesetindex">
          <TabBar
            :pane_id="paneset[0]"
          ...
          <multipane
            ...
            <template
              ...
              <div
                ...
                :style="{ width: panes.disposition.type!=='colfirst'?''+(100/paneset.length)+'%':'100%', height: panes.disposition.type!=='colfirst'?'100%':''+(100/paneset.length)+'%', flexGrow:1 }"
                :key="panesubsetindex">
                  <TabBar
                    :pane_id="pane_id"
